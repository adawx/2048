...
import { MissingApiKeyError, suggestMove } from '../suggestions/suggestMove'
...
export function Game() {
  ...
  async function requestSuggestion() {
    ...
    try {
      ...
      setSuggestion(error instanceof MissingApiKeyError ? error.message : 'Unable to get a suggestion.')
    } finally {
